...
\begin{rdefi}{\tiny Définition}
    ...
    \textbf{endroit fixé} la perturbation \textbf{sur sa durée}.}
\end{rdefi}
...
\begin{rexem}{Application}
    ...
    \begin{enumerate}
        \item À quel instant la vague arrive-t-elle au point d'abscisse $x_1 =
            ...
            \cswitch{white}{
                À $t=0$, la tête de la vague est à $x_0 = \SI{400}{km}$. Elle
...
\begin{rdefi}{Définition}
    ...
    dépend de la fréquence ou de la longueur d'onde}.\bigbreak
