...
\begin{minipage}{0.70\linewidth}
    \begin{enumerate}[label=\sqenumi]
        \litem{De quoi parle-t-on~?} On étudie le mouvement d'une masse de
...
\begin{enumerate}[label=\sqenumi, start=4]
    ...
    \litem{Équations scalaires.} On projette le PFD sur les axes~:
        \[
            \left\{
                \begin{array}{rcl}
            ...
            \right.
        \]
    \litem{Résolution.} La première équation n'est pas utilisable telle qu'elle,
