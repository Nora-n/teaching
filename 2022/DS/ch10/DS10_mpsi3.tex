...
\switch{
	...
	\begin{minipage}[t]{.73\linewidth}
		\begin{enumerate}[start=2]
			...
			\]
			\nitem{2} La compacité est le rapport du volume occupé par les entités sur
			...
			\ce{ZrO2}.
			\nitem{2} La coordinence d'une entité est son nombre de plus proches voisins
	...
	\begin{enumerate}[start=9]
		...
		\nitem{1} Si la substitution se fait le plus simplement possible, un cation
...
\switch{
	...
	\begin{enumerate}[start=2]
		...
		\leftcenters{D'où}{$\DS\boxed{\Mcf_z = -mB_0\sin{\theta}\uz}$}
...
\switch{
	...
	\begin{enumerate}
		...
		\nitem{3} Par définition de la puissance d'une force $\Pc_L=\vv{F_L}\cdot\vv{v}$.
		Or $\vv{v}=\xp\ex$.
		\smallbreak
		...
		On en déduit $\boxed{\Pc_L=-B_0ia\cos(\alpha)\xp}$~: \fbox{\textbf{réponse
				C)}}
		\nitem{4} On étudie la barre en translation selon $\ex$, dans le référentiel
