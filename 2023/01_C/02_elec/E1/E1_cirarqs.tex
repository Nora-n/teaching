...
% \begin{tcb}[label=def:convrg](defi){Conventions selon dipôle}
...
% \begin{tcbraster}[raster columns=3, raster equal height=rows]
%
% 	\begin{tcb}[label=def:serdiv, valign lower=center, valign upper=center](defi)
% 		{série et dérivation}
%
...
% 	\end{tcb}
% 	\begin{tcb}[label=coro:serdiv, valign lower=center, valign upper=center](coro)
% 		{série et dérivation}
%
...
%
% 	\end{tcb}
% 	\begin{tcb}[label=exem:serdiv](exem){Série et dérivation}
% 		\begin{center}
