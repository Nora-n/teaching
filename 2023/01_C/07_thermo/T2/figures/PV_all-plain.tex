...
\begin{tikzpicture}
	...
	\draw[domain=\xb:\xa,samples=\N, smooth,
		white, very thick, flch={pos=.7}, mynode={.7}{left}{IsoT}]
	plot (\x,\isotherm{\x}{\Th})
	;
	% ISOP, ISOV
	\draw[very thick, flch={pos=.7}, white, mynode={.5}{below}{IsoP}] (B) -- (A|-B);
	\draw[very thick, flch={pos=.7}, white, mynode={1}{above}{IsoV}] (B) -- (C);
	% ADIABATIC
	\draw[domain=\xb:\xa,samples=\N, smooth,
		white, very thick, flch={pos=.9}, mynode={.8}{right}{Adia}]
