...
\begin{enumerate}[label=\sqenumi, start=3]
	\item \switch{
          ...
          \begin{gather*}
            x_v(A_1) = \SI{27.500 \pm 0.058}{cm}
            \qet
            x_v(A_2) = \SI{42.100 \pm 0.058}{cm}
            \\
            \text{soit} \qquad
          ...
          \begin{gather*}
            x_b(A_1) = \SI{14.000 \pm 0.058}{cm}
            \qet
            x_b(A_2) = \SI{29.200 \pm 0.058}{cm}
            \\
            \text{soit} \qquad
...
\begin{enumerate}[label=\clenumi, start=8]
	\item \switch{
		      ...
		      \smallbreak
          Pour observer l'image virtuelle obtenue, il faut que l'image en
          question soit visible avec le viseur dans l'espace image réelle de la
