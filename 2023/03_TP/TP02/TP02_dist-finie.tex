...
\begin{enumerate}[label=\clenumi, start=2]
	\item \switch{
		      ...
		      image nette.
		      \smallbreak
		      Pour cela, on commence avec $D$ grand et on cherche 2 positions nettes, et
		      on réduit progressivement $D$ jusqu'à n'en avoir plus qu'une. On relève la
		      plage de validité de $D$, on prend la valeur centrale et l'incertitude-type
		      sera la demi-largeur de l'intervalle divisé par $\sqrt{3}$.
		      \smallbreak
...
\begin{enumerate}[label=\sqenumi, start=3]
	\item \switch{
		      ...
		      directement sur le banc optique). Déterminer les incertitudes relatives, et
		      en déduire l'écart normalisé.
	      }{
		      En cours…
	      }
\end{enumerate}
...
\begin{enumerate}[label=\sqenumi, start=4]
	\item \switch{
		      Réaliser la mesure du grandissement du viseur.
	      }{
		      En cours…
	      }
	\item \switch{
...
\begin{enumerate}[label=\sqenumi, start=6]
	...
	\item \switch{
		      Estimez les incertitudes, puis calculer
...
\begin{enumerate}[label=\clenumi, start=8]
	\item \switch{
		      ...
		      \smallbreak
		      Pour avoir une image virtuelle, ???
		      \smallbreak
...
\begin{enumerate}[label=\sqenumi, start=12]
	...
	\item \switch{
	      Appliquer la méthode de \textsc{Silbermann} pour obtenir $f'_{\rm silb}$
