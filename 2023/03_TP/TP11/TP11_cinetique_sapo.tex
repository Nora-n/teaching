	...
	\begin{tcb}(expe){}
		\begin{enumerate}
			\item Prélever $\SI{50}{mL}$ de soude mesurés avec une fiole jaugée et
			      ...
			      \begin{center}
				      \begin{tcb}[width=.8\linewidth](rapp){Rappel}
					      \centering
...
\QR{%
	...
	On perd des ions oxonium de grande conductivité pour gagner des \ce{RCOO-}
...
\QR{%
	Faire la régression linéaire (sur régressi ou sur votre calculatrice)
