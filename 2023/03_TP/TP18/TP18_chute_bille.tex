...
\QR{%
	La comparer à la valeur théorique de la viscosité $\eta\ind{theo} =
		\SI{1,5}{SI}$.
}{%
	On est à la moitié de la valeur théorique~! Avec cette valeur de $\eta$, on
	devrait avoir $\tau\ind{theo} = \SI{37}{ms}$…
}
