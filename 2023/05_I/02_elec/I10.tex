...
% \newcommand{\splus}{\raisebox{.2\height}{\scalebox{.8}{+}}}
% \newcommand{\sminu}{\raisebox{.4\height}{\scalebox{.8}{-}}}
...
\begin{enumerate}[label=\sqenumi]
	...
	\begin{isd}[righthand ratio=.3]
		\wsw{
			La résonance survient lorsqu'un système extérieur apporte de l'énergie
			à un système oscillant à sa fréquence «~naturelle~», dite «~de
			résonance~». Le système oscillant a alors une amplitude de variation
			maximale. Exemple~: instrument à vent. Avec $X(\w)$ l'amplitude réel du
			signal excité, on a
			\begin{align*}
				\text{résonance}
				\quad & \Lra \quad
