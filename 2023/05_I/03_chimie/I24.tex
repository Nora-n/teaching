...
\begin{enumerate}[label=\sqenumi]
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item
			      \leftcentersright{%
			      \psw{$\ce{{Fe}^2+_{\rm(aq)}/{Fe(OH)_2}_{\rm(s)}}$~:}
			      }{%
			...
			\item \leftcentersright{%
			      \psw{$\ce{{Fe}^3+_{\rm(aq)}/{Fe(OH)_3}_{\rm(s)}}$~:}
			      }{%
			      \psw{$\ce{{Fe(OH)_3}_{\rm(s)} =
					      {Fe}^3+_{\rm(aq)} + 3 {HO}^-_{\rm(aq)}}$}
			      }{%
			      \psw{$K_{s,3}$}
			      }%
			      \vspace{-15pt}
		...
		\begin{itemize}
			\item \leftcenters{%
			      \psw{$\ce{{Fe(OH)_2}_{\rm(s)}/Fe_{\rm(s)}}$~:}
			      }{%
			      $\psw{\ce{
			      ...
			      \vspace{-15pt}
			\item \leftcenters{%
			      \psw{$\ce{{Fe(OH)_3}_{\rm(s)}/{Fe}^2+_{\rm(aq)}}$~:}
			      }{%
			      $\psw{\ce{
			      ...
			      \vspace{-15pt}
			\item \leftcenters{%
			      \psw{$\ce{{Fe(OH)_3}_{\rm(s)}/{Fe(OH)_2}_{\rm(s)}}$~:}
			      }{%
			      \hspace{20pt}
			      $\psw{\ce{
