...
\QR[3]{%
	Montrer que considérer la poussée d'Archimède sur la bille est équivalent à
	considérer une bille de masse volumique $\rho = \rho_a - \rho_g$ qui n'est pas
...
\QR[6]{%
	...
	canonique et en déduire a constante de temps $\tau$ caractéristique du régime
	transitoire, ainsi que la vitesse limite $v_l$ atteinte par la bille.
}{
