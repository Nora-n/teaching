...
\makeatletter
\renewcommand{\@chapapp}{MPSI3 -- 16 février 2024 -- Devoir surveillé}
\makeatother
...
\chapter{\cswitch{Correction du DS}{Mécanique (2) et structure de la matière}}
\label{ch:ds06}
...
\enonce{
	...
	\begin{tcb}*[cnt, bld](ror)<itc>{Au programme}
		\large
		Toute la mécanique jusqu'aux particules chargées (mouvements courbes,
		énergie, particules chargées)~; architecture de la matière 1 et 2.
	\end{tcb}
	\vfill
	\minitoc
	\vfill
