...
\begin{document}
\exercice[43]{Molécules de \textsc{Lewis}}
...
\enonce{
	...
	\bigbreak
	La molécule d’ozone (\ce{O3}) possède deux isomères (deux formules de Lewis)~:
	l’un coudé, l’autre cyclique dont l'existence reste douteuse.
}

\QR[4]{%
	Proposer une structure (en justifiant) de Lewis pour l'isomère coudé.
}{%
	\vspace{-15pt}
...
\QR[1]{%
	Proposer une structure (en justifiant) de Lewis pour l'isomère cyclique.
}{%
...
\QR[2]{%
	Proposer (en justifiant) une structure de Lewis pour la molécule \ce{H2O2}.
}{%
...
\QR[2]{%
	Donner (en justifiant) la représentation de Lewis du diiode.
}{%
	Chaque atome d'iode possède $7$ électrons de valence, donc le molécule de
	Lewis du diiode possède $7$ doublets \pt{1} d'électron. De plus, chaque atome
...
\QR[1]{%
	Donner la formule de Lewis de la molécule d’eau.
}{%
	\[
		\cfig{
			H-\charge{90=\|,-90=\|}{O}-H
