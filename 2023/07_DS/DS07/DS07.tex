...
\makeatletter
\renewcommand{\@chapapp}{MPSI3 -- 22 mars 2024 -- Devoir surveillé}
\makeatother
...
\chapter{\cswitch{Correction du DS}{Mécanique du solide et des forces centrales}}
\label{ch:ds07}
...
\enonce{
	...
	\begin{tcb}*[cnt, bld](ror)<itc>{Au programme}
		\large
		Toute la mécanique, principalement moment cinétique, forces centrales et
		mécanique solide.
	\end{tcb}
