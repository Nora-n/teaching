...
\begin{document}
\exercice[47]{Satellite en orbite terrestre\ifcorrige{~\small\textit{(D'après
			TSI 2010)}}}
...
\QR[5]{%
	...
	\]
	Ainsi, le travail élémentaire de la force $\Ff$ peut se mettre sous la forme
	$-\dd \Ec_p$, donc elle est conservative et dérive de l'énergie $\DS\Ec_p(r)
		\stm{=} -\frac{\Gc M_Tm}{r}+C$. En choisissant $\Ec_p(+\infty) \stm{=} 0$, on
	a $C=0$, et on en déduit
	\[
		\Ec_p(r)=-\frac{k}{r}
		\qav
		\boxed{k \stm{=} \Gc M_Tm}
