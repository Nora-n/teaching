...
\chapter{\cswitch{Correction du DS}{Transformations de la matières}}
\label{ch:ds07}
...
\enonce{
	...
	\begin{tcb}*[cnt, bld](ror)<itc>{Au programme}
		\large
		Toute la chimie sauf la cinétique~: acide-base, précipitation,
		oxydoréduction et diagrammes $E-\pH$
	\end{tcb}
