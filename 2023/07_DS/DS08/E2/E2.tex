...
\enonce{
	...
	terrestre ($0,03\%$) , où on le trouve sous forme de chromite \ce{FeCr2O4}. On
	le trouve également dans le règne végétal dans la canne à sucre, la levure de
	bière, les noix, les épices et dans le règne animal dans le foie et les
	graisses. Il est utilisé dans le chromage des métaux, le tannage du cuir, la
	...
	donner la couleur vert émeraude). Il est également employé pour faire des
	alliages comme l'acier inoxydable ($70\%$ Fe, $20\%$ Cr, $10\%$ Ni). Plusieurs
	de ses sels sont de puissants oxydants.

	\subsubsection*{Données :}%
	\begin{itemize}%
		\item Numéro atomique du chrome : $Z=24$
		\item Produit ionique de l'eau à \SI{298}{\kelvin} : $K_e=10^{-14}$
		\item Produit de solubilité de \ce{Cr(OH)3} : $K_{s_1}=10^{-31}$
		\item Produit de solubilité de \ce{Ag2CrO4} : $K_{s_2}=10^{-12}$
	\end{itemize}%
}%
