...
\begin{tcbraster}[raster columns=4, raster equal height=rows]
	\begin{tcn}*[raster multicolumn=3](null)<non>{}
		...
		pour avril 2026.
		% ~; sachant que la seconde est courte (les cours se
		% terminent en avril), il vous faut vite intégrer la chose suivante~:
	\end{tcn}
