...
\begin{tcb*}[label=prop:rsortie, sidebyside,
		righthand ratio=.3](prop){Résistance de sortie pour $E_0$}
	...
	\end{center}
\end{tcb*}
\begin{tcb*}[label=demo:rsortie](demo){Résistance de sortie pour $E_0$}
	\psw{%
...
\begin{tcb*}[label=prop:rsortie, sidebyside,
		righthand ratio=.3](prop){Résistance de sortie pour $I_0$}
	...
	\end{center}
\end{tcb*}
\begin{tcb*}[label=demo:rsortie](demo){Résistance de sortie pour $I_0$}
	\psw{%
