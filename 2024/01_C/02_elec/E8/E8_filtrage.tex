		      ...
		      \begin{isd}[righthand ratio=.2]
			      ...
			      \psw{%
				      \begin{gather*}
					      G\ind{B} (x) = \log (G(x)^2)
					      \Ra
					      G\ind{dB} (x) = 10 \log (G(x)^2)
					      \\\Lra
					      \boxed{G\ind{dB}(x) = 20 \log G(x)}
				      \end{gather*}
			      }%
			      \vspace{-25pt}
			      \tcblower
		...
		\item[m]
		      \psw{%
			      ...
			      \begin{align*}
				      ...
				      \\\Lra
				      20 \log ( G(\w_2) ) & =
				      20 \log (\frac{G(\w_1)}{10})
				      \\\Lra
				      20 \log ( G(\w_2) ) & =
				      20 \log (G(\w_1)) - 20 \log (10)
				      \\\Lra
	...
	\begin{enumerate}[start=2]
		\item[m]
		      \psw{%
			      \small
			      \begin{align*}
				      G(\w)           & \geq \frac{G_{\max}}{\sqrt{2}}
				      \\\Lra
				      20 \log (G(\w)) & \geq 20 \log (\frac{G_{\max}}{\sqrt{2}})
				      \\\Lra
				      G\ind{dB}(\w)   & \geq
				      \underbracket[1pt]{20 \log (G_{\max})}_{= G\ind{dB, max}} -
...
\begin{tcb*}(prop){Passe-bas intégrateur}
	...
	\psw{%
		\[
			\Hu(\w) \Sim_{\w\to\infty} \frac{\w_c}{\jw}
			\Lra
			\boxed{\Su \Sim_{\w\to\infty} \frac{\w_c}{\jw}\Eu}
		\]
	}
\end{tcb*}
...
\begin{tcb*}(prop){Passe-haut dérivateur}
	...
	\psw{%
		\[
			\Hu(\w) \Sim_{\w\to\infty} \frac{\jw}{\w_c}
			\Lra
			\boxed{\Su \Sim_{\w\to\infty} \frac{\jw}{\w_c}\Eu}
		\]
	}
	\vspace{-15pt}
\end{tcb*}
