			      ...
			      \item Pour le gain~:
			            \begin{itemize}
				            \item[b]{Asymptotes}~:
				                  \psw{%
					                  \[
						                  G\ind{dB}(x) \Sim{x\to 0} 20 \log (1) = 0
						                  \qet
						                  G\ind{dB}(x) \Sim{x\to\infty} 20 \log \abs{\frac{1}{\jx}} = -20 \log
						                  x
					                  \]
...
\begin{tcb*}[sidebyside, lefthand ratio=.3](demo){$\Hu$ RC sur R}
	\begin{center}
		\sswitch{%
...
\vspace{-15pt}
\subsubsection{Fonction de transfert, généralisation}
\begin{tcb*}[sidebyside, lefthand ratio=.3](demo){$\Hu$ RLC sur C}
	\begin{center}
		\sswitch{%
...
\vspace{-15pt}
\subsubsection{Fonction de transfert, généralisation}
\begin{tcb*}[sidebyside, lefthand ratio=.3](demo){$\Hu$ RLC sur R}
	\begin{center}
		\sswitch{%
