...
\begin{tikzpicture}[tdplot_main_coords]
	...
	\begin{pgfonlayer}{background}
		\draw[ultra thick,-latex] (0,0,0) -- (7,0,0) node[pos=1.1]{$x$};
		\draw[ultra thick,-latex] (0,0,0) -- (0,7,0) node[pos=1.05]{$y$};
		\draw[ultra thick,-latex] (0,0,0) -- (0,0,6) node[pos=1.05]{$z$};
	\end{pgfonlayer}

	%Help Lines
	\begin{pgfonlayer}{background}
		%Up
		\draw[very thick, blue] (O) -- (A) node[pos=0.6, above left, blue] {$r$};
		\draw[thick] (O) -- (B);
		\draw[thick] (O) -- (C);
	...
	\begin{pgfonlayer}{foreground}
		...
		\tdplotdrawarc[thick, tdplot_rotated_coords]{(O)}{\rvec}{\thetavec+\dthetavec}{90}{}{}
		\tdplotdrawarc[thick, tdplot_rotated_coords]{(O)}{\rvec+\drvec}{\thetavec+\dthetavec}{90}{}{}
		\tdplotsetthetaplanecoords{\varphivec+\dvarphivec}
		\tdplotdrawarc[thick, tdplot_rotated_coords, dashed]{(O)}{\rvec}{\thetavec+\dthetavec}{90}{}{}
		\tdplotdrawarc[thick, tdplot_rotated_coords]{(O)}{\rvec+\drvec}{\thetavec+\dthetavec}{90}{}{}
		%
		\tdplotdrawarc[thick, tdplot_main_coords]{(O)}{\rvec}{\varphivec}{\varphivec+\dvarphivec}{}{}
		\node[rotate=13] at (3,4.45,0) {$r\sin\theta\mathrm{d}\varphi$};
		\tdplotdrawarc[thick, tdplot_main_coords]{(O)}{\rvec+\drvec}{\varphivec}{\varphivec+\dvarphivec}{}{}
	\end{pgfonlayer}
	...
	\begin{pgfonlayer}{foreground}
		%varphi, dvarphi
		\tdplotdrawarc[thick, -stealth]{(O)}{0.9}{0}{\varphivec}{anchor=north}{$\varphi$}
		\tdplotdrawarc[thick, -stealth]{(O)}{1.5}{\varphivec}{\varphivec + \dvarphivec}{}{}
		\node at (1.4,1.9,0) {$\mathrm{d}\varphi$};

		\tdplotsetthetaplanecoords{\varphivec}

		%Theta, dTheta
		\tdplotdrawarc[thick, tdplot_rotated_coords, -stealth]{(0,0,0)}{1.2}{0}{\thetavec}{}{}
		\node at (0,0.3,1.3) {$\theta$};
		\tdplotdrawarc[thick, tdplot_rotated_coords, -stealth]{(0,0,0)}{2.}{\thetavec}{\thetavec + \dthetavec}{anchor=south west}{$\mathrm{d}\theta$}
	\end{pgfonlayer}
	...
	\begin{pgfonlayer}{foreground}
		\tdplotsetthetaplanecoords{\varphivec}
		\tdplotdrawarc[tdplot_rotated_coords, thick]{(O)}{\rvec}{\thetavec}{\dthetavec + \thetavec}{below,rotate=-60}{$r\mathrm{d}\theta$}
