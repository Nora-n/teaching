...
\begin{tikzpicture}[scale=0.4]
	...
	\draw[thick] \LG;
	\draw[thick] \SL;
	\path[dashed] (M) -- ($(M |- 0,0)$) coordinate (Mx);
	\path[dashed] (T) -- ($(T |- 0,0)$) coordinate (Tx);
	\path[dashed] (T) -- ($(T -| 0,0)$) coordinate (Ty);
	\path[dashed] (B) -- ($(B |- 0,0)$) coordinate (Bx);
	\path[dashed] (B) -- ($(B -| 0,0)$) coordinate (By);
	\path[dashed] (C) -- ($(C |- 0,0)$) coordinate (Cx);
	\path[dashed] (C) -- ($(C -| 0,0)$) coordinate (Cy);
