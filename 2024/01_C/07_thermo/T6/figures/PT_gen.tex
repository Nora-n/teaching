...
\begin{tikzpicture}[scale=0.4]
	...
	% \node[thick, draw] at (O)  {O};
	% \node[thick, draw] at (N1) {N1};
	% \node[thick, draw] at (N2) {N2};
	% \node[thick, draw] at (NE) {NE};
	% \node[thick, draw] at (NW) {NW};
	% \node[thick, draw] at (SE) {SE};
	% \node[thick, draw] at (W)  {W};
	% \node[thick, draw] at (S)  {S};
	% \node[thick, draw] at (C)  {C};
	% \node[thick, draw] at (T)  {T};
