...
fig.savefig("./Ul_ampl_stud.pdf", bbox_inches="tight")

ax.plot(wlist, ampl_list, color="firebrick")

fig.savefig("./Ul_ampl_prof.pdf", bbox_inches="tight")
...
fig.savefig("./Ul_arg_stud.pdf", bbox_inches="tight")

ax.plot(wlist, arg_list, color="firebrick")

fig.savefig("./Ul_arg_prof.pdf", bbox_inches="tight")
