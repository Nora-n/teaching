...
\QR{%
	...
	\begin{DispWithArrows*}
		...
		\\\Lra
		\dv[2]{u_C}{t} + \frac{R}{L} \dv{u_C}{t} + \frac{1}{LC}u_C &= \frac{E}{LC}
		\\\Lra
		\dv[2]{u_C}{t} + \frac{\w_0}{Q} \dv{u_C}{t} + \w_0{}^2 u_C &= \w_0{}^2E
		\Arrow{$q = Cu_C$}
		\\\Lra
		\dv[2]{q}{t} + \frac{\w_0}{Q} \dv{q}{t} + \w_0{}^2 q &= \w_0{}^2CE
	\end{DispWithArrows*}
	Régime critique pour $Q = 1/2$~:
	\begin{gather*}
		Q = \frac{1}{2} \Lra \frac{1}{R}\sqrt{\frac{L}{C}} = \frac{1}{2}
		\Lra
		R_c = 2 \sqrt{\frac{L}{C}}
		\qav
		\left\{
...
\enonce{%
	\begin{tcb}(expe){}
		Faire varier $R$ de façon à observer un régime pseudo-périodique très
...
\enonce{%
	...
	\begin{tcb}[sidebyside, righthand ratio=.25](expe){}
		\begin{enumerate}
