...
\enonce{%
	\begin{tcb}(rema)<lftt>{Régression}
		...
		$\sigma_{\infty}$. Il peut valoir le coup de refaire une mesure en faisant
		bien attention à rincer la cellule de conductimétrie.
		\smallbreak
		\textbf{Dans le pire des cas}, modifiez la valeur de $\sigma_{\infty}$ de
		sorte à obtenir $b = 1$ l'ordonnée à l'origine (vous pouvez trouver la
		valeur de $\sigma_{\infty}$ à l'aide d'une boucle for en affichant $b$ et
		$\sigma_{\infty}$).
	\end{tcb}
}%
