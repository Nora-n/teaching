...
\chapter{Électrocinétique~: ARQS et résistances\ifstudent{~(15')}}
...
\begin{enumerate}[label=\sqenumi, leftmargin=10pt]
	\item[n]{4} %
	      ...
	      \begin{isd}[righthand ratio=.3]
		      \psw{%
			      ...
			      F$'$A$'$B$'$, en remarquant que $\obarr{OH} = \AB$, et les triangles FAB
			      et FOH' pour avoir
			      \begin{gather*}
				      ...
				      \frac{\obarr{FO}}{\obarr{FA}}
				      \Lra
				      \obarr{F'O'}\obarr{FO} = \obarr{F'A'}\obarr{FA}
				      \Lra
				      \boxed{\OFp\OF = \obarr{F'A'}\obarr{FA}}
				      \hspace{12pt}
				      \pt{1}
			      \end{gather*}
		      }%
	...
	\item[n]{2} %
	      ...
	      \end{isd}
	\item[n]{5} %
	      Représenter et flécher deux résistances $R_1$ et $R_2$ en série et le
	      schéma équivalent avec $R\ind{eq}$. Démontrer son expression.
	      \smallbreak
	      ...
	      \begin{isd}[lefthand ratio=.3]
		      ...
		      \psw{%
			      \begin{align*}
				      ...
				      \\\Lra
				      \Aboxed{R_{\rm eq}  & \stm{=} \frac{R_1R_2}{R_1+R_2}}
				      \qed
			      \end{align*}
		      }%
		      \vspace{-15pt}
	...
	\item[n]{+2} %
	      ...
	      \smallbreak
	      \psw{%
		      Lightwaves hitting silver atoms make them vibrate and emit spherical
