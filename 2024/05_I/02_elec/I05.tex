...
\begin{enumerate}[label=\sqenumi, leftmargin=10pt]
	...
	\item[n]{7}%
	      ...
	      %       phases} (axe $x = u_C(t)$, axe $y = i(t)$), et \textbf{indiquer le sens
	...
	\item[n]{+2}%
	      ...
	      \smallbreak
	      \psw{%
		      At the junction between two different metals, electrons can gain
		      or lose heat because of the increased or reduced electrical potential
		      energy levels between them, so a current creates a difference in
		      temperature.
	      }%
\end{enumerate}
