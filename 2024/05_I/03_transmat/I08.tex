...
\begin{enumerate}[label=\sqenumi, leftmargin=10pt]
	...
	\item[n]{5}%
	      ...
	      \vspace{\fill}
	\item[n]{+2}%
	      Explain what fuming nitric acid is and which safety measure is best suited
	      when using this compound.
	      \smallbreak
	      \psw{%
		      Fuming nitric acid is highly concentrated nitric acid, with a
		      purity of above 90\%. Maybe counterintuitively, it's best to use without
		      gloves because the acid puts them on fire in under 4 seconds.
	      }%
\end{enumerate}
