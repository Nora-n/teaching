...
\begin{enumerate}[label=\sqenumi]
	...
	\item[n]{3}%
	      ...
	      \psw{
		      \begin{enumerate}
			      \item[l][20pt]{\protect\pt{1}}
			            $\exists \Rc$ galiléens $: (\forall \Mr ~|~ \sum \Ff_{\ext\to\Mr} =
				            \of)$, $\Mr$ est soit au repos, soit en translation rectiligne
			            uniforme~;
			      \item[l][20pt]{\protect\pt{1}} $\dv{\pf\Rg(\Mr)}{t} = \sum \Ff_{\ext\to\Mr}$~;
			      \item[l][20pt]{\protect\pt{1}} $\forall (\Mr_1,\Mr_2), \Ff_{1\to2} = -\Ff_{2\to 1}$.
		      \end{enumerate}
	      }
	\item[n]{4}%
	...
	\item[n]{9}%
	      ...
	      \psw{
		      ...
		      \begin{minipage}[c]{.60\linewidth}
			      \begin{enumerate}[label=\sqenumi]
				      \item[b]{\ltm[20pt]{\protect\pt{1}}Système}~:
				            \{balle\} dans $\Rc\ind{labo}$ supposé galiléen
				      \item[b]{\ltm[20pt]{\protect\pt{1}}Schéma}~:
				            cf.\ figure.
				      \item[b]{\ltm[20pt]{\protect\pt{1}}Modélisation}~:
				            repère $(\!\ux,\uy,\uz)$ (cf.\ schéma),
				            \smallbreak
				            repérage $\OM = x\ux +y\uy$, $\vf = \xp\ux+\yp\uy$, $\af =
					            \xpp\ux+\ypp\uy$.
				      \item[b]{\ltm[20pt]{\protect\pt{1}}Conditions initiales}~:
				            $\OM (0) = \of$ et
				            \smallbreak
				            $\vf(0) = v_0\cos(\alpha)\ux+ v_0\sin(\alpha)\uy$
				      \item[b]{\ltm[20pt]{\protect\pt{1}}BdF}~: $\Pf = -mg\uy$
			      \end{enumerate}
		      \end{minipage}
