...
\begin{enumerate}[label=\sqenumi]
	...
	\item[n]{4}%
	      ...
	      \psw{
		      ...
		      \begin{gather*}
			      \beforetext{Or,}
			      \pf_{\Sc/\Rc}(t) \stm{=} \sum_i \pf_{\Mr_i/\Rc}(t)
			      \qet
			      \vf_{\Gr/\Rc}(t) = \dv{\vvr{OG}}{t} = \frac{1}{m_{\tot}}
			      \sum_i m_i \dv{{\OM}_i}{t}
			      \Lra
			      \boxed{\pf_{\Sc/\Rc} \stm[-1]{=} m_{\tot}\vf_{\Gr/\Rc}}
		      \end{gather*}
	...
	\item[n]{9}%
	      ...
	      et $\uy$ du mouvement, et déterminer l'équation de la trajectoire.
	      Portez une attention particulière à l'établissement du système.
	      \smallbreak
	      \psw{
		      \noindent
