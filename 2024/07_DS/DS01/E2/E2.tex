...
\begin{document}%
\section[38]"E"{Optique d'un périscope\ifcorrige{~\small\textit{(D'après ENAC 2024)}}}
...
\QR[9]{%
	L'objet étant encore à l'infini, on règle $\Sc_p$ de telle sorte que $e = e_0
		- \ep$, où $\ep > 0$, $\ep \ll f_2'$ et $\ep \ll f_1'$. Que peut-on affirmer~?
	...
	\hfill$\boxed{\DS\frac{1}{1+x} \Sim_{x \ll 1} 1-x}$\hspace*{\fill}
}{%
