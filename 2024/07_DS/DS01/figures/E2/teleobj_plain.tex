...
\begin{tikzpicture}[scale=.5]
	...
	\draw[Brown!50, simple, thick] (O1) --++ ($(O1)-(A)$);
	% % Plan focal
	% \def\pfsiz{4}
	...
	% \draw[brandeisblue, fleche={.5}{>}, dashed] (It2) -- (Ite);
	% \draw[brandeisblue, double, dashed] (Ib2) -- (Ibe);
	% % Image intermédiaire
	...
	% \draw[orange!70, double, name path=IBp] (I) -- (Ob);
	% % image finale
	% \node[] at (P) {$\times$};
