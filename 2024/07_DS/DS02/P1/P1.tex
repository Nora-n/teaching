...
\QR[5]{%
	Donner les solutions réelles possibles de cette équation. Par un argument sur
	l'évolution de $u$ en fonction de $x$, déterminer alors laquelle des deux
	solutions convient. Donner un encadrement du discriminant $\Delta$. En déduire
	un encadrement de $u$.
}{%
