...
\makeatletter
\renewcommand{\@chapapp}{MPSI3 -- 22 novembre 2024 -- Devoir surveillé}
\makeatother
...
\iftoggle{corrige}{}{
	...
	\begin{enumerate}
		\item Inscrire dans le cadre attitré une remarque \textbf{pertinente} issue
		      du \textbf{DS03} de l'\textbf{année précédente}.
		\item De même avec une remarque pertinente du \textbf{DS02} de \textbf{cette
			      année}.
	\end{enumerate}
}
