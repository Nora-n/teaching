...
\QR[6]{%
	Donner la définition du quotient réactionnel pour cette équation. Relier alors
	la constante d’équilibre $K^\circ$ aux pressions partielles à l’équilibre des
	différents constituants du système et à la pression standard $P^\circ$,
	d'abord, puis aux quantités de matière à l’équilibre des différents
	constituants du système, à la quantité de matière totale à l’équilibre
	$n\ind{tot}$, à la pression totale $P$ et à la pression standard $P^\circ$.
}{%
	~
	\smallbreak
	\vspace{-15pt}
