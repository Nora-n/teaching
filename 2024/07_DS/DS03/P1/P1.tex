...
\QR[10]{%
	...
	\begin{isd}[interior hidden]
		...
		Ainsi, le condensateur est déchargé, et $\boxed{u(0^-) = 0}$ \pt{1}, et
		aucun courant ne circule dans le circuit, donc $\boxed{i(0^-) = 0}$ \pt{1}.
		\begin{center}
		...
		$\boxed{i(0^+) = i (0^-) = 0}$ \pt{1} et $\boxed{u(0^+) = u (0^-) = 0}$ \pt{1}.
		\begin{center}
