...
\QR[5]{%
	...
	\end{gather}
	\noindent
	On exprimera $\w_0$ et $\xi$ en fonction de $k$, $m$ et $\gamma$.
}{%
	~
	\smallbreak
	\vspace{-15pt}
...
$X_m \exr^{-\xi\w_0t}$, $x_0$, $v_0$ et $T={2\pi}/{\W}$ la pseudo-période.
}{%
Allure du graphe ci-contre. La pente à l'origine est $v_0 \neq 0$.
\begin{center}
