...
\QR[3]{%
	...
	\begin{gather*}
		...
		\frac{R(1-LC\w^2)+\jlw}{\jrlw}
		\Lra
		\boxed{\Zu \stm{=} \frac{\jrlw}{R(1-LC\w^2)+\jlw}}
	\end{gather*}
}
...
\QR[5]{%
	...
	\begin{isd}
		...
		\begin{DispWithArrows*}[fleqn, mathindent=0pt]
			\xul{U_0} &\stm{=} \Zu\eta_0 = \frac{\jrlw}{R(1-LC\w^2)+\jlw}\eta_0
			\Arrow{Factorise\\par $\jrlw$}
			\\\Lra
			\xul{U_0} &\stm{=} \frac{R\eta_0}{1+\jj R \pa{C\w-\frac{1}{L\w}} }
		\end{DispWithArrows*}
		\tcblower
		\vspace{-15pt}
