...
\makeatletter
\renewcommand{\@chapapp}{MPSI3 -- 26 janvier 2024 -- Devoir surveillé}
\makeatother
...
\chapter{\cswitch{Correction du DS}{Filtrage, ondes et mécanique}}
\label{ch:ds05}
...
\enonce{
	...
	\begin{tcb}*[cnt, bld](ror)<itc>{Au programme}
		\large
		Toute l'électrocinétique, oscillateurs en RSF résonance et filtrage~; toutes
		les ondes et interférences~; cinématique et dynamique du point sans
		mouvement courbe.
	\end{tcb}
	\vfill
	\minitoc
