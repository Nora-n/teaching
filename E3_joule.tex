...
\QR{%
	...
	son énergie interne ne dépend que de la température, et comme la
	transformation est isotherme on a $\Delta{U} = 0$. Ainsi,
	\[
...
\QR{%
	...
	intervenant sont forcément positives. Il vient donc qu'\textbf{une résistance
		électrique est forcément positive}.
}%
\QR{%
